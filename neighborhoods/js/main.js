...
// ==========================================
        ...
        function applySingleModeCenteringFromRenderedCard(markerLatLng, attempt = 0, isInitialCentering = false) {
            ...
            console.log('Single mode: applying setCenter, isInitial:', isInitialCentering);
        ...
        function initMap() {
            ...
            // Single mode: Show loading overlay, initialize at TRUE marker position (no pre-offset)
            // Centering will be applied ONCE after InfoWindow renders, then overlay fades
            ...
            if (isSingleMode && singleModeTarget) {
                ...
                // NO pre-offset - start at true marker position
                mapCenter = initialCenter;
                console.log('Single mode: starting at TRUE center (no pre-offset), overlay shown');
            ...
            // Map center - true marker position in single mode (offset applied after InfoWindow renders)

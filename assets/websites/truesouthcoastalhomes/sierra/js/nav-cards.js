...
(function() {
  ...
  function renderBreadcrumb() {
    ...
    var breadcrumbHtml = [
      ...
      '<a href="/" class="text-primary-600 hover:text-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500" style="color: var(--color-primary-600);"><i class="fa fa-home"></i></a>',
  ...
  function createAreaCard(preset, propType, neighborhoodData, urlOverrides) {
    ...
    for (var i = 0; i < maxRows; i++) {
      ...
      // Get URL slug for hyperlink: { "Community": { "homes": { "urlSlug": "..." } } }
      var override = urlOverrides[n.name] || {};
      var urlSlug = (override[actualType] && override[actualType].urlSlug) || '';

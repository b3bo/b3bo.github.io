...
export const CONFIG = {
    ...
    data: {
        ...
        // NOTE: These paths are for LOCAL DEV. Deploy script transforms to ../assets/mls/ecar/
        neighborhoodFiles: [
        ...
        areaPresetsFile: '../assets/mls/ecar/presets/areas.json.b64',

        // Path to MLS manifest for hashed file lookups
        manifestFile: '../assets/mls/ecar/manifest.json',

        // Path to geojson boundary files (zip code boundaries)
        geojsonPath: '../assets/mls/ecar/boundaries/'
    },
    ...
    ui: {
        ...
        priceSteps: [
            250000, 300000, 350000, 400000, 450000, 500000, 550000, 600000, 650000, 700000, 750000, 800000, 850000,
            900000, 950000, 1000000, 1250000, 1500000, 1750000, 2000000, 2250000, 2500000, 2750000, 3000000, 3250000,
            3500000, 3750000, 4000000, 4250000, 4500000, 4750000, 5000000, 6000000, 7000000, 8000000, 9000000, 10000000,
    ...
    // COLOR PALETTE
    // ===================================================================
    // Note: Primary brand colors are defined in assets/websites/truesouthcoastalhomes/neighborhoods/css/styles.css

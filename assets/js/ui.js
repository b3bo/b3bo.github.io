...
function setupSortDropdown() {
    ...
    sortMenu.innerHTML = CONFIG.ui.sortOptions.map(option => {
        ...
        return `
            <button class="sort-option w-full px-4 py-2 text-sm cursor-pointer flex items-center justify-start gap-2 text-left hover:bg-neutral-50 ${isActive ? 'active bg-neutral-50 text-neutral-800 font-medium' : 'text-neutral-600 font-normal'}" data-sort-id="${option.id}">

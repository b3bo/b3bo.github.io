...
(function() {
  ...
  function createAreaCard(preset, propType, neighborhoodData, urlOverrides) {
    ...
    for (var i = 0; i < maxRows; i++) {
      ...
      var nameCell = urlSlug
        ? '<a href="' + urlSlug + '" title="' + linkTitle + '">' + n.name + ' ' + actualTypeLabel + linkIcon + '</a>'
  ...
  var baseUrl = 'https://neighborhoods.truesouthcoastalhomes.com/neighborhoods/jsons/';

  var jsonFiles = {
    presets: '586d18ae76449d78.json.b64',
    neighborhoods: [
      '7ea1bf14d884d192.json.b64',
      'b762bb338ba328e5.json.b64',
      'd2ea7fdfc87ff3e7.json.b64',
      'd897c3d107c48ccc.json.b64',
      'dcb3d8a92cc6eb54.json.b64',
